...
export class ApiService {
  ...
  sendForgetPassword(email) {
    ...
    const res = this.http.post('https://vaservice.the-v.net/site.aspx', body, this.options).toPromise();
  ...
  getVideos(count, page) {
    ...
    return this.http.post('https://cums.the-v.net/site.aspx', body, this.options)
      .toPromise()
    //   res => {
    //     return res.json();
    //     // this.load.dismiss();
