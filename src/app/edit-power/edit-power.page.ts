        ...
        res => {
          ...
          if (res == "True") {
            ...
            this.storage.get('user').then(u=>{
              console.log(u);
              let holder = u;
              holder.Email = this.profile.Email;
              holder.ContactNumber = this.profile.Contact;
              holder.Name = this.profile.Name;
              console.log(holder);
              this.storage.set('user', holder).then(()=>{
